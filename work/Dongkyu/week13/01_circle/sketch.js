...
function draw() {
  background(0);
  var numOfPoints = 100; // number of circle points
  var sizeOfCircle = 100; // size of whole background circle //http://setosa.io/ev/sine-and-cosine/
  stroke(255);
  ...
  for( var i=0; i < numOfPoints; i++) {
      ...
      var lineLength = Math.PI * 1.5 * sizeOfCircle;
